            ...
            
            {
                proyectos.map((proyecto) => (
                    <article key={proyecto.id} className="cardProyect w-full flex flex-col mb-7 md:grid md:grid-cols-12 md:items-center md:gap-6">
                        ...
                        <h3 className="w-full order-1 font-bold pt-3 text-blue-600 mb-4 text-3xl text-center md:hidden">{proyecto.title}</h3>                                           
                        {/* container text */}
                        <div className="textProyect order-3 mt-4 md:order-2 md:col-span-6 md:flex md:flex-col md:justify-center md:text-left md:mt-0">
                            ...
                            <h3 className="w-full font-bold hidden text-blue-600 text-3xl text-center md:block">{proyecto.title}</h3>                                                    
                            ...
                            <p className="mt-3 mb-6 px-6 text-justify text-base md:px-0 lg:text-lg">{proyecto.description}</p>                            
                        </div>
                        {/* container btn */}
