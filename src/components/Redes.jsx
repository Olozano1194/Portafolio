    ...
    return (
        <section id='redes' className="redesDiv text-justify text-[1rem] text-slate-800 border-b-2 border-stone-900 p-7 md:text-[1.3rem]">
            <article className='font-ubuntu leading-9'>
                ...
                <p>
                    Mi enfoque principal es el ecosistema Front-End, donde construyo interfaces dinámicas y funcionales utilizando JavaScript, React y Tailwind CSS.
                </p>
                <p>
                    Puedes Explorar mis proyectos en GitHub, ver mi perfil profesional en LinkedIn o descarga mi CV.
                </p>
                <p>
