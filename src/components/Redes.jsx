...
function Redes() {
    return (
        <section id='redes' className="redesDiv text-justify text-[1rem] text-slate-950 border-b-2 border-stone-900 p-7 md:text-[1.4rem]">
            ...
            <p>Ingeniero de sistemas, graduado de la institución de educación superior      <span className='font-bold'>ITFIP</span>.<br></br> Me he especializado en desarrollo Front-End, con experiencia en tecnologías como JavaScript, React y Tailwind.<br></br>
